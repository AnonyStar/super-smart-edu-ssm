...
<div class="f-main">
    ...
    <div class="clearfix">
        <div class=main-category>
            <div class="main-bg">
                <c:forEach items="${sites}" var="item" varStatus="statu" >
                    <a href="${item.url}">
                        <div class="main-bg-item " style="background-image: url('${item.picture}'); ">
                            <div class="main-title-${statu.count}"></div>
                        </div>
                    </a>
            ...
            <div class="f-nav-box">
                <div class="bg-nav">
                    <c:forEach items="${sites}" varStatus="status" var="item">
            ...
            <div class="main-category-menu">
                <c:forEach items="${categroys}" var="item" varStatus="index">
                    <div class="category" c-id="categroy-${index.index}">
                        <a>
            ...
            <c:forEach items="${categroys}" varStatus="index" var="item">

                    <div class="main-category-submenu-content" id="categroy-${index.index}">

                        <div class="clearfix">
                            <div class="submenu-title clearfix">分类目录</div>
                            <c:forEach items="${item.classifyList}" var="cate">
                            <a class="submenu-item" href="/course/list?c=${cate.code}">${cate.name}</a>
                            <a class="submenu-item">/</a>
                            </c:forEach>
                        </div>
                        <div class="clearfix">
                            <div class="submenu-title" style="margin-top: 30px;">课程推荐</div>
                            <c:forEach items="${item.courses}" var="coures">
                                <div>
                                    <a href="/course/learn/${coures.id}.html" class="mt-10" title="${coures.name}">
                                        <li class="ellipsis oc-color-hover">➤ ${coures.name}</li>
                                    </a>
                                </div>
                            </c:forEach>
        ...
        <a href="">
            <div class="lecturer-card-container">
                <div class="lecturer-item">
                    ...
                    <span class="lecturer-name">煮酒论青梅</span>
                    <span class="lecturer-title">简码在线</span>
                    <span class="lecturer-p">简码在线高级讲师，擅长写代码</span>
                </div>
            </div>
        </a>
