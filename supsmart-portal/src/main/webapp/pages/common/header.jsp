    ...
    <div class="f-header">
        <div class="f-header-box clearfix">
            ...
            <nav class="header-nav">
                ...
                <a href="/course/list.html" class="header-nav-item">我的</a>
            ...
            <nav class="header-nav" style="float:right">
                ...
                <!--<@shiro.user>-->
                <a href="/user/home.html" class="header-nav-item"
                   style="margin-left:0px;width:40px;height:40px;" id="userdetail">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="loginForm" class="form-horizontal" style="padding: 0px 20px;" method="POST"
                          action="${s.base}/auth/ajaxlogin.html">
                        <div class="form-group">
                            <input id="usernameHeader1" type="text" class="form-control" name="username"
                                   placeholder="用户名">
                        </div>
                        ...
                        <div class="form-group">
                            <input id="identiryCodeHeader1" class="form-control" name="identiryCode" maxlength="6"
                                   class="input-text" type="text" style="width: 120px;float:left;"
                                   placeholder="请输入验证码"/>
                    ...
                    <form id="registeForm" method="POST" action="${s.base}/auth/doRegister.html" class="form-horizontal"
                          style="padding: 0px 20px;display: none;">
                        <div class="form-group">
                            <input id="usernameHeader2" name="username" type="text" class="form-control"
                                   placeholder="用户名">
                        </div>
                        <div class="form-group help">
